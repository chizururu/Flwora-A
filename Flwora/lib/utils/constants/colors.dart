...
class TColors {
  ...
  static const Color textError = Color(0xFFD90429);
  ...
  static const Color inputErrorBorder = Color(0xFFD90429);

  // Banner
  static const Color bannerError = Color(0xFFFEF5F5);
  static const Color bannerErrorText = Color(0xFFD90429);
  ...
  static const Color snowRed = Color(0xFFFEF5F5);
  static const Color flagRed = Color(0xFFD90429);
}
