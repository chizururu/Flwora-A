class TSizes {
  // Padding, spacing, dan margin size
  ...
  static const double menuHeight = 500;

  // Menu list size height
  static const double menuListHeight = 250;
}
